  ...
  Pod::Spec.new do |s|
    ...
    s.license = 'MIT'
    s.homepage = 'https://github.com/diachedelic/capacitor-background-geolocation'
    s.author = 'James Diacono'
    s.source = { :git => 'https://github.com/diachedelic/capacitor-background-geolocation', :tag => s.version.to_s }
